...
export function RevealText({
  ...
  useEffect(() => {
    ...
    const play = () => {
      letters.forEach((l) => {
        const delay = Math.random() * 850; // "random smoke" scatter
        l.style.transition = `opacity 1.1s ${delay}ms cubic-bezier(0.22,1,0.36,1), filter 1.1s ${delay}ms cubic-bezier(0.22,1,0.36,1), transform 1.1s ${delay}ms cubic-bezier(0.22,1,0.36,1)`;
        l.style.opacity = "1";
