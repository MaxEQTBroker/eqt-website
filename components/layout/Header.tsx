          ...
          {!open && (
            <>
              <a
                ...
                className="inline-flex items-center gap-1.5 rounded-full border px-3 py-1 text-[0.68rem] font-semibold uppercase tracking-[0.2em] transition-colors hover:opacity-80"
              ...
              <a
                ...
                className="inline-flex items-center gap-1.5 rounded-full bg-[#25D366] px-3 py-1 text-[0.68rem] font-semibold uppercase tracking-[0.2em] text-[#04310f] shadow-sm transition-colors hover:bg-[#1ebe5b]"
              >
                <svg viewBox="0 0 24 24" className="h-3.5 w-3.5" fill="currentColor" aria-hidden="true">
